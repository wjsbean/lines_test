# Generated by Django 2.1.1 on 2018-10-29 02:40
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='Info_Experiment',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('test_name', models.CharField(max_length=40, verbose_name='试验名称')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('info_testLines', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='summary.Info_TestLines')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.AddField(
            ...
            name='info_testLines',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='summary.Info_TestLines'),
        ),
        migrations.AddField(
            model_name='info_experiment',
            name='line_name',
        ...
        migrations.AddField(
            model_name='info_experiment',
            name='test_group',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='summary.PurposeRequirement', verbose_name='试验组别'),
        ),
        migrations.AddField(
            model_name='info_experiment',
            name='test_unit',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='summary.Info_ExperiLocation', verbose_name='承试单位'),
        ),
        migrations.AddField(
